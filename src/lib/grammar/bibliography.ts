...
export const BIBLIOGRAPHY: BibEntry[] = [
	...
	{ key: "Fujiyama (ELPR)", region: "sakhalin", full: "Fujiyama, Haru, narrator. Sakhalin Ainu narratives (recorded 1959), in the Endangered Languages of the Pacific Rim (ELPR) series." },
	...
	{ key: "Ono 2020", region: "general", reported: true, full: "Ono (2020). Reclassification of the Ainu dialects by spectral clustering — a reanalysis of Asai (1974) yielding a two-way Sakhalin / Hokkaido(+N. Kuril) split. [reported]" },
	{ key: "Murayama 1971", region: "general", reported: true, full: "Murayama, Shichirō 村山七郎 (1971). On the classification of the Ainu dialects, incl. the position of Kuril Ainu. [reported]" },
	{ key: "Satō-Bugaeva 2019", region: "general", reported: true, full: "Satō, Tomomi & Anna Bugaeva (2019). On Kuril Ainu and the internal classification of Ainu. [reported]" },
