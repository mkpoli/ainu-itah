...
<S t="Arguments and their omission" id="argument-omission">
	...
	<Ex
		...
		g="this 1SG-see"
		tr="I see this."
		cite="furukawa1967:103"
		dial="WS"
		place="Rayciska (Fujiyama Haru)"
	/>
	<Ex
		m="taranoka aynu uta tampe en-konte-hci"
		g="that.PL person PL this 1SG.O-give-PL"
		tr="Those people gave this to me."
		cite="furukawa1967:117"
		dial="WS"
		place="Rayciska (Fujiyama Haru)"
	/>
	<p>
...
<S t="Constituent order" id="word-order">
	...
	<Ex
		...
		g="old.woman stick hold while walk PROG exist.SG"
		tr="The old woman is walking, holding a stick."
		cite="furukawa1967:119"
		dial="WS"
		place="Rayciska (Fujiyama Haru)"
	...
	<Ex
		...
		g="QUOT say REP two young.man"
		tr="…so said the two young men."
		cite="murasaki2001:text 3"
		dial="WS"
		place="Odasu (Asai Take)"
		note="The dislocated subject follows the clause-final reportative; the preceding quotation is a prohibitive (§17.5)."
	/>
</S>
...
<S t="The noun phrase" id="np-order">
	...
	<Ex
		...
		g="2SG-two-dog-POSS"
		tr="your two dogs"
		cite="furukawa1967:104"
		dial="WS"
		place="Rayciska (Fujiyama Haru)"
		note="The 2SG prefix and the possessive suffix enclose numeral plus noun; see Chapter 7."
	/>
</S>
...
<S t="Questions" id="questions">
	...
	<Ex
		m="neya nispa eh wa"
		g="that gentleman come.SG Q"
		tr="Has the gentleman come?"
		cite="furukawa1967:105"
		dial="WS"
		place="Rayciska (Fujiyama Haru)"
		note="Falling intonation; the same segmental string with rising pitch is an imperative ‘come!’."
	/>
	<Ex
		m="pirika-ha aa"
		g="be.good-POSS Q"
		tr="Has it healed?"
		cite="furukawa1967:109"
		dial="WS"
		place="Rayciska (Fujiyama Haru)"
...
<S t="Commands and invitations" id="directives">
	...
	/>
	<Ex
		m="nee carehaw kii wa i-nuu-re kanne"
		g="some story do and INDEF.O-hear-CAUS FIN"
		tr="Tell us a story, please."
...
<S t="The final-particle slot" id="clause-types">
	...
	<table>
		...
		<thead>
			<tr><th>Particle</th><th>Use</th></tr>
		</thead>
		<tbody>
			<tr><td><i lang="ain">kanne</i></td><td>polite request</td></tr>
			<tr><td><i lang="ain">wa</i> (rising)</td><td>plain command</td></tr>
			<tr><td><i lang="ain">wa</i> (falling)</td><td>question</td></tr>
			<tr><td><i lang="ain">kah</i></td><td>brusque command to intimates</td></tr>
			<tr><td><i lang="ain">anaa</i></td><td>polite invitation, ‘let's’</td></tr>
			<tr><td><i lang="ain">roo ~ roh</i></td><td>strong invitation among equals</td></tr>
			<tr><td><i lang="ain">nanko</i></td><td>defiant refusal, ‘as if I would!’</td></tr>
			<tr><td><i lang="ain">neya</i></td><td>counterfactual wish, ‘if only’</td></tr>
			<tr><td><i lang="ain">(kusu) iki</i></td><td>confident assertion about the future</td></tr>
			<tr><td><i lang="ain">naa</i></td><td>confident warning or prediction</td></tr>
			<tr><td><i lang="ain">wanaa</i></td><td>‘there, just as expected’</td></tr>
			<tr><td><i lang="ain">noo</i></td><td>exclamation, admiration</td></tr>
			<tr><td><i lang="ain">okaa</i></td><td>wish, ‘I would like’</td></tr>
			<tr><td><i lang="ain">aa</i></td><td>emphatic question on a perfect form</td></tr>
		</tbody>
	</table>
	<p>
	...
	<Ex
		m="ne aynu ka isam"
		g="any person even not.exist"
		tr="There is nobody at all."
		cite="furukawa1967:107"
		dial="WS"
		place="Rayciska (Fujiyama Haru)"
	/>
</S>
